...
**large numbers are much larger than small numbers, and small numbers are more than large numbers**
...
visitors_with_nations %>% 
  mutate(visitors,
         proportion = case_when(
             nation == "England" ~ 93/240,
             nation == "Northern Ireland" ~ 1/9,
             nation == "Scotlans" ~ 34/97,
             TRUE ~ 0
           ))
